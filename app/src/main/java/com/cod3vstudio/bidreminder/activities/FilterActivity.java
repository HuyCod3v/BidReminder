...
import com.cod3vstudio.bidreminder.databinding.ActivityFilterBinding;
...
public class FilterActivity extends BaseActivity<ActivityFilterBinding, FilterViewModel> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setBindingContentView(R.layout.activity_filter, BR.viewModel);
